  ...
  })(
    {
      ...
      31: [
        function (e, t, r) {
          (function (r) {
            function n(e, t) {
              return u("sessionStorage failed with", t), a(), (s = l), s.get(e);
            }
            function o(e, t) {
            ...
            function i() {
              try {
                return (
                  "sessionStorage" in r &&
                  null !== r.sessionStorage &&
                  (r.sessionStorage[c] ||
                    r.sessionStorage.setItem(c, JSON.stringify({})),
                  !0)
                );
              } catch (e) {
                return !1;
            ...
            var s,
              ...
              p = {
                set: function (e, t) {
                  l.set(e, t);
                  try {
                    var o = JSON.parse(r.sessionStorage[c]);
                    return (
                      (o[e] = t), (r.sessionStorage[c] = JSON.stringify(o)), o[e]
                    );
                  } catch (i) {
                    return n(e, i);
                  }
                ...
                get: function (e) {
                  try {
                    return JSON.parse(r.sessionStorage[c])[e] || null;
                  } catch (t) {
                    return n(e, t);
                  }
                },
            ...
            (s = i() ? p : l),
              (t.exports = { get: o, set: o, supportssessionStorage: i });
          }.call(
            this,
            "undefined" != typeof global
              ? global
